      ...
      <div className="flex ml-8">
        <div className="w-[700px] text-white">
          ...
          <div className='flex mt-12 space-x-3'>
              <button className='py-3 px-10 bg-neutral-800 rounded hover:bg-neutral-700'>Check Demos</button>
            <button className='py-3 px-10 bg-blue-700 rounded hover:bg-blue-600'><a href="https://themeforest.net/item/tailux-react-tailwind-admin-template/56397379" target='_blank'>Get Now &rarr; </a></button>
          </div>
        </div>
